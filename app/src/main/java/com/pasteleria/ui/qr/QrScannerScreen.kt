...
import com.pasteleria.utils.QrScanner
...
fun QrScannerScreen(
    ...
    var hasPermission by remember { mutableStateOf(CameraPermissionHelper.hasCameraPermission(context)) }
